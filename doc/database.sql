...
(
   id              	BIGINT PRIMARY KEY COMMENT '主键',
   meta_id       	BIGINT NOT NULL COMMENT '目标id=meta.id',
   ...
   res_url          VARCHAR(150)  COMMENT '资源网络路径',
...
(
   id            			BIGINT PRIMARY KEY COMMENT '主键',
   meta_id    		BIGINT NOT NULL COMMENT '类别Id=meta.id',
   title     	 				VARCHAR(150) NOT NULL COMMENT '标题',
   cover_url    	 		VARCHAR(150)  NULL COMMENT '封面',
