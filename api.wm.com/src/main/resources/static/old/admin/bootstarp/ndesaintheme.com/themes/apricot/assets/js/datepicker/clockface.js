        ...
        parseTime: function(value) {
          var hour = null, 
            ...
            if(parts && parts.length) {
              ...
              ampm = (!parts[3] || parts[3].toLowerCase() === 'static.lib.jquery.a') ? 'am' : 'pm';
            } else {
              ...
              if(parts && parts.length) {
                ampm = (!parts[1] || parts[1].toLowerCase() === 'static.lib.jquery.a') ? 'am' : 'pm';
                //reverse back
        ...
        getTime: function(asObject) {
          ...
          if(!this.is24) {
            if(result.indexOf('A') !== -1) {
               ...
               result = result.replace('static.lib.jquery.a', this.ampm);
            }
          }
